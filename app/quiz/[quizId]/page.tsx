...
export async function generateMetadata({
    ...
    return {
        ...
        description: `Take the ${quiz.title} quiz on ${quiz.topic}. Created by ${quiz.creatorName}. ${quiz.description || ''}`,
        openGraph: {
            type: "website",
            ...
            images: [
                {
                    url: `${process.env.NEXT_PUBLIC_BASE_URL}/api/screenshot?quizId=${quizId}`,
                    width: 1200,
                    height: 630,
                },
            ],
        ...
        twitter: {
            ...
            description: `Take the ${quiz.title} quiz on ${quiz.topic}. Created by ${quiz.creatorName}.`,
            images: [
                `${process.env.NEXT_PUBLIC_BASE_URL}/api/screenshot?quizId=${quizId}`,
            ],
        },
    };
}
