...
export const Header = memo(() => {
  ...
  return (
    <div className="h-16 fixed top-0 left-0 right-0 z-[100] bg-background/95 backdrop-blur border-b supports-[backdrop-filter]:bg-background/60"> {/* Set a fixed height for the header container */}
